        ...
        <>
          ...
          <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4 pointer-events-none">
            <motion.div
              ...
              className="bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl w-full sm:max-w-md sm:w-full max-h-[80vh] sm:max-h-[70vh] overflow-hidden flex flex-col pointer-events-auto"
